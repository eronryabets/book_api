...
env = environ.Env(
    ...
    DATABASE_NAME_BOOK_API=str,
    DATABASES_USER_BOOK_API=str,
    DATABASES_PASSWORD_BOOK_API=str,
    DATABASE_HOST_BOOK_API=str,
    DATABASE_PORT_BOOK_API=(int, 5434),
)
...
DATABASES = {
    "default": {
        ...
        "NAME": env('DATABASE_NAME_BOOK_API'),
        "USER": env('DATABASES_USER_BOOK_API'),
        "PASSWORD": env('DATABASES_PASSWORD_BOOK_API'),
        "HOST": env('DATABASE_HOST_BOOK_API'),
        "PORT": env('DATABASE_PORT_BOOK_API'),
    },
}
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'book_api.authentication.JWTAuthentication',
    ),
